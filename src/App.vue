    ...
    <div id="app">
        <main class="container mx-auto">
            ...
            <div class="flex items-center border-b border-b-2 border-teal-500 py-2">
                <input type="text" class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" placeholder="Search..." aria-label="Full name" v-model="query" v-on:keypress="fetchWeather">
            </div>
            <!-- end searchbar -->
            <!-- start weather output -->
            <div class="mx-auto max-w-sm rounded overflow-hidden shadow-lg" v-if="typeof weather.main != 'undefined'">
                <div class="px-6 py-4">
                ...
                <div class="bg-gray-700 rounded text-white bg-opacity-50 px-6 py-4">
                    ...
                    <p class="flex justify-center text-3xl text-base">
                        <img :src="`${icon+weather.weather[0].icon}.png`" alt="weather-icon">
            ...
            <div class="mx-auto mt-5 max-w-sm rounded overflow-hidden shadow-lg" v-else>
